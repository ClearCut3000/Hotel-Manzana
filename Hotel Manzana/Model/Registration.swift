...
extension Registration {
  static var sample: [Registration]{
    return [
      ...
      Registration(firstName: "Joe", lastName: "Average", emailAdress: "avaragejoe@thereisnospoon.edu", checkInDate: .now, checkOutDate: .now.addingTimeInterval(60 * 60 * 24), numberOfAdults: 1, numberOfChildren: 0, roomType: RoomType(id: 7, name: "Run of house", shortName: "ROH", price: 99), wifi: false),
    ]
  }
